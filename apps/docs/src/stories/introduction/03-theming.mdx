...
We use [bootstrap](https://github.com/edificeio/edifice-frontend-framework/tree/develop/packages/bootstrap) package to theme our components and applications.
...
Clone edifice-frontend-framework and install.

```
git clone https://github.com/edificeio/edifice-frontend-framework.git
pnpm install
```
...
This watcher will listen all changes in `bootstrap` package. Storybook already imports the styles. So you can see any CSS you are writing with HMR.
